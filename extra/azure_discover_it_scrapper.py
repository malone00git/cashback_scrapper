...
payload = {'api_key': 'b0ffba61bd71478efe146c578bc1940d',
           'url': 'https://www.discover.com/credit-cards/cash-back/cashback-calendar.html', 'render': 'true'}
...
if response.status_code == 200:
    ...
    try:
        ...
        # Delete the files
        os.remove(FN_DISCOVER_QUARTERS)
        os.remove(FN_DISCOVER_CATEGORIES)
